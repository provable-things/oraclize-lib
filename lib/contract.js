...
// TODO decide if contract object should handle sanitization of
// decimal input, or let engine handle it
...
function setContract(thisContract, parsedContract) {
    ...
    utils.writeProtected(thisContract, ['output', 'daterange'], parsedContract.daterange);
    utils.writeProtected(thisContract, ['output', 'interval'], parsedContract.interval);
    utils.writeProtected(thisContract, ['output', 'actions'], parsedContract.actions);
    utils.writeProtected(thisContract, ['output', 'conditions'], parsedContract.payload.conditions);
